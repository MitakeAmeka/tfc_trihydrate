...
public class HydrocycloneRecipeSerializer extends IERecipeSerializer<HydrocycloneRecipe> {
    @Override
    public HydrocycloneRecipe readFromJson(ResourceLocation recipeId, JsonObject json, IContext context) {
        ...
        return new HydrocycloneRecipe(recipeId, outputFluid, outputItem.get(), inputFluid, energy);
    }

    @Override
    public HydrocycloneRecipe fromNetwork(@Nonnull ResourceLocation recipeId, @Nonnull FriendlyByteBuf buffer) {
        ...
        return new HydrocycloneRecipe(recipeId, outputFluid, outputItem, inputFluid, energy);
    }

    @Override
    public void toNetwork(@Nonnull FriendlyByteBuf buffer, HydrocycloneRecipe recipe) {
